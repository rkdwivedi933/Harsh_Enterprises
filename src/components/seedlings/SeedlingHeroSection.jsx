...
export default function SeedlingHeroSection() {
  const highlights = [
  ...
  >
    High-Quality Seedling Trays for Healthy Plant Growth
  </motion.h2>
  ...
  >
    Our seedling trays are designed to provide the perfect environment
    for early plant growth. Made from durable, reusable materials,
    they ensure proper root development, easy handling, and uniform
    germination. Available in multiple colors and cavity sizes, our
    trays are ideal for nurseries, polyhouses, and commercial farming.
  </motion.p>

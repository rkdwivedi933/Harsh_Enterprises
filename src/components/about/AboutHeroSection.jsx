      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full">
        <div className="grid lg:grid-cols-2 items-center">
          ...
          <div className="max-w-xl">
            ...
            >
              Harsh Enterprises is a leading manufacturer of agricultural
              products dedicated to supporting modern farming practices.
              With a strong focus on quality, sustainability, and innovation,
              we deliver reliable solutions that help farmers grow better
              and faster.
            </motion.p>
